...
x2 = np.linspace(mean[1] - 7, mean[1] + 7, 100)
...
plt.title("Problem 3 - Full Covariance")
...
plt.plot(
    [ mean[0] - major_vector[0] * major_length,   mean[0] + major_vector[0] * major_length],
      [mean[1] - major_vector[1] * major_length,mean[1] + major_vector[1] * major_length],color="red",label="Major Axis")

plt.plot([mean[0] - minor_vector[0] * minor_length, mean[0] + minor_vector[0] * minor_length],
    [mean[1] - minor_vector[1] * minor_length,  mean[1] + minor_vector[1] * minor_length],color="black",label="Minor Axis")

plt.xlabel("X1")
plt.ylabel("X2")

plt.title("Problem 3 - Major and Minor Axes")
